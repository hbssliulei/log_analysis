...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/2918581?v=2&amp;s=400" property="og:image" /><meta content="twbs/bootstrap" property="og:title" /><meta content="https://github.com/twbs/bootstrap" property="og:url" /><meta content="bootstrap - The most popular front-end framework for developing responsive, mobile first projects on the web." property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="7250C104:7B5D:F8DA6C2:53F1D7FF" name="octolytics-dimension-request_id" />
...
<meta content="Azt6DccXOdfqDoyzf4bnPMoQhcoUf9KCm6mnRcTpScgJG8X5C7GXD71OfcRh5vPvRYGFMNcZA2ZoLXGP5D8d0A==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Ftwbs%2Fbootstrap%2Fblob%2Fmaster%2Fdocs%2Fassets%2Fjs%2Fie-emulation-modes-warning.js">Sign in</a>
    </div>
...
<a href="/twbs/bootstrap/blob/ea0e1606dc8f6a351c850a3e51889872c0f07c31/docs/assets/js/ie-emulation-modes-warning.js" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:f190e39b2c67fe05d70ae979e9e7f596 -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/twbs/bootstrap/blob/nav-tag-for-navbar/docs/assets/js/ie-emulation-modes-warning.js"
                 data-name="nav-tag-for-navbar"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text css-truncate-target"
                 title="nav-tag-for-navbar">nav-tag-for-navbar</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
...
<div class="file-box">
  ...
  <div class="blob-wrapper data type-javascript">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-line-code js-file-line"><span class="c1">// NOTICE!! DO NOT USE ANY OF THIS JAVASCRIPT</span></td>
      </tr>
      <tr>
        <td id="L2" class="blob-line-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-line-code js-file-line"><span class="c1">// IT&#39;S JUST JUNK FOR OUR DOCS!</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC5" class="blob-line-code js-file-line"><span class="cm"> * Copyright 2014 Twitter, Inc.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC7" class="blob-line-code js-file-line"><span class="cm"> * Licensed under the Creative Commons Attribution 3.0 Unported License. For</span></td>
      </tr>
      <tr>
        <td id="L8" class="blob-line-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-line-code js-file-line"><span class="cm"> * details, see http://creativecommons.org/licenses/by/3.0/.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC10" class="blob-line-code js-file-line"><span class="c1">// Intended to prevent false-positive bug reports about Bootstrap not working properly in old versions of IE due to folks testing using IE&#39;s unreliable emulation modes.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-line-code js-file-line">  <span class="kd">function</span> <span class="nx">emulatedIEMajorVersion</span><span class="p">()</span> <span class="p">{</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC16" class="blob-line-code js-file-line">    <span class="k">if</span> <span class="p">(</span><span class="nx">groups</span> <span class="o">===</span> <span class="kc">null</span><span class="p">)</span> <span class="p">{</span></td>
      </tr>
      <tr>
        <td id="L17" class="blob-line-num js-line-number" data-line-number="17"></td>
        <td id="LC17" class="blob-line-code js-file-line">      <span class="k">return</span> <span class="kc">null</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC19" class="blob-line-code js-file-line">    <span class="kd">var</span> <span class="nx">ieVersionNum</span> <span class="o">=</span> <span class="nb">parseInt</span><span class="p">(</span><span class="nx">groups</span><span class="p">[</span><span class="mi">1</span><span class="p">],</span> <span class="mi">10</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L20" class="blob-line-num js-line-number" data-line-number="20"></td>
        <td id="LC20" class="blob-line-code js-file-line">    <span class="kd">var</span> <span class="nx">ieMajorVersion</span> <span class="o">=</span> <span class="nb">Math</span><span class="p">.</span><span class="nx">floor</span><span class="p">(</span><span class="nx">ieVersionNum</span><span class="p">)</span></td>
      </tr>
      <tr>
        <td id="L21" class="blob-line-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-line-code js-file-line">    <span class="k">return</span> <span class="nx">ieMajorVersion</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC24" class="blob-line-code js-file-line">  <span class="kd">function</span> <span class="nx">actualNonEmulatedIEMajorVersion</span><span class="p">()</span> <span class="p">{</span></td>
      </tr>
      <tr>
        <td id="L25" class="blob-line-num js-line-number" data-line-number="25"></td>
        <td id="LC25" class="blob-line-code js-file-line">    <span class="c1">// Detects the actual version of IE in use, even if it&#39;s in an older-IE emulation mode.</span></td>
      </tr>
      <tr>
        <td id="L26" class="blob-line-num js-line-number" data-line-number="26"></td>
        <td id="LC26" class="blob-line-code js-file-line">    <span class="c1">// IE JavaScript conditional compilation docs: http://msdn.microsoft.com/en-us/library/ie/121hztk3(v=vs.94).aspx</span></td>
      </tr>
      <tr>
        <td id="L27" class="blob-line-num js-line-number" data-line-number="27"></td>
        <td id="LC27" class="blob-line-code js-file-line">    <span class="c1">// @cc_on docs: http://msdn.microsoft.com/en-us/library/ie/8ka90k2e(v=vs.94).aspx</span></td>
      </tr>
      <tr>
        <td id="L28" class="blob-line-num js-line-number" data-line-number="28"></td>
        <td id="LC28" class="blob-line-code js-file-line">    <span class="kd">var</span> <span class="nx">jscriptVersion</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Function</span><span class="p">(</span><span class="s1">&#39;/*@cc_on return @_jscript_version; @*/&#39;</span><span class="p">)()</span> <span class="c1">// jshint ignore:line</span></td>
      </tr>
      <tr>
        <td id="L29" class="blob-line-num js-line-number" data-line-number="29"></td>
        <td id="LC29" class="blob-line-code js-file-line">    <span class="k">if</span> <span class="p">(</span><span class="nx">jscriptVersion</span> <span class="o">===</span> <span class="kc">undefined</span><span class="p">)</span> <span class="p">{</span></td>
      </tr>
      <tr>
        <td id="L30" class="blob-line-num js-line-number" data-line-number="30"></td>
        <td id="LC30" class="blob-line-code js-file-line">      <span class="k">return</span> <span class="mi">11</span> <span class="c1">// IE11+ not in emulation mode</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC32" class="blob-line-code js-file-line">    <span class="k">if</span> <span class="p">(</span><span class="nx">jscriptVersion</span> <span class="o">&lt;</span> <span class="mi">9</span><span class="p">)</span> <span class="p">{</span></td>
      </tr>
      <tr>
        <td id="L33" class="blob-line-num js-line-number" data-line-number="33"></td>
        <td id="LC33" class="blob-line-code js-file-line">      <span class="k">return</span> <span class="mi">8</span> <span class="c1">// IE8 (or lower; haven&#39;t tested on IE&lt;8)</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC35" class="blob-line-code js-file-line">    <span class="k">return</span> <span class="nx">jscriptVersion</span> <span class="c1">// IE9 or IE10 in any mode, or IE11 in non-IE11 mode</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC38" class="blob-line-code js-file-line">  <span class="kd">var</span> <span class="nx">ua</span> <span class="o">=</span> <span class="nb">window</span><span class="p">.</span><span class="nx">navigator</span><span class="p">.</span><span class="nx">userAgent</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC40" class="blob-line-code js-file-line">    <span class="k">return</span> <span class="c1">// Opera, which might pretend to be IE</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC42" class="blob-line-code js-file-line">  <span class="kd">var</span> <span class="nx">emulated</span> <span class="o">=</span> <span class="nx">emulatedIEMajorVersion</span><span class="p">()</span></td>
      </tr>
      <tr>
        <td id="L43" class="blob-line-num js-line-number" data-line-number="43"></td>
        <td id="LC43" class="blob-line-code js-file-line">  <span class="k">if</span> <span class="p">(</span><span class="nx">emulated</span> <span class="o">===</span> <span class="kc">null</span><span class="p">)</span> <span class="p">{</span></td>
      </tr>
      <tr>
        <td id="L44" class="blob-line-num js-line-number" data-line-number="44"></td>
        <td id="LC44" class="blob-line-code js-file-line">    <span class="k">return</span> <span class="c1">// Not IE</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC46" class="blob-line-code js-file-line">  <span class="kd">var</span> <span class="nx">nonEmulated</span> <span class="o">=</span> <span class="nx">actualNonEmulatedIEMajorVersion</span><span class="p">()</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC48" class="blob-line-code js-file-line">  <span class="k">if</span> <span class="p">(</span><span class="nx">emulated</span> <span class="o">!==</span> <span class="nx">nonEmulated</span><span class="p">)</span> <span class="p">{</span></td>
      </tr>
      <tr>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.02824s from github-fe124-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
